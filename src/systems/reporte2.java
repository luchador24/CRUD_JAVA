...
public class reporte2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID CARRETERA", "NOMBRE", "PAIS", "NO. DE CARRILES", "CAT. DE CARRETERA"
            }
        ));
        ...
        jLabel1.setText("Ingrese la Categoría");
        ...
        jLabel2.setText("2.- Indicar el total de carreteras que existen según categoría");
    ...
    public void mostrar()
    {
        ...
        String busqueda = "SELECT idCarretera, nombre, pais, numCarriles, nombreCategoriaCarretera FROM Carretera, categoria WHERE Carretera.idcategoria = categoria.idcategoria AND categoria.nombreCategoriaCarretera='"+ categoria.getText().trim()+"'";
        ...
        try 
        {
            ...
            modelo.setColumnIdentifiers(new Object[]{"ID CARRETERA","NOMBRE","PAIS","NO. DE CARRILES","CAT. DE CARRETERA"});
            while (rs.next())
            {
                ...
                String xCat = rs.getString("nombreCategoriaCarretera");              
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(categoria.getText().trim().equals("")){
            JOptionPane.showMessageDialog(rootPane, "Ingrese alguna categoría");
        }else{
            mostrar();
        }
